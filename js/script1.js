...
function changeLanguage(lang) {
    ...
    document.querySelector('.heading').innerHTML = `<i class="fas fa-user-alt"></i> ${translations[lang].aboutMe}`;
    document.querySelector('.education .heading').innerHTML = `<i class="fas fa-graduation-cap"></i> ${translations[lang].myEducation}`;
    document.querySelector('.contact .heading').innerHTML = `<i class="fas fa-headset"></i> ${translations[lang].getInTouch}`;
}
...
var typed = new Typed(".typing-text", {
    strings: ["website development", "Digital Marketing",  "IT Business Development", "Data Science"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
